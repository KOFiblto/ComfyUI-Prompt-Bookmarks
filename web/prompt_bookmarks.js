...
async function manualCreatePrompt() {
  ...
  for (const b of bindings) {
    ...
    const txt = document.createElement("textarea"); txt.className = "pb-input"; txt.rows = 3; txt.placeholder = b.widget_name;
    wrap.append(lbl, txt);

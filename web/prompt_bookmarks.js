...
const I18N = {
  "zh-CN": {
    ...
    exportDb: "导出数据库文件 (.db)",
    importDb: "恢复数据库文件 (.db)",
    importDbConfirm: "确定要恢复此数据库文件吗？当前数据库将被备份为 .db.bak。",
    dbImported: "数据库已成功恢复",
    dbLocation: "本地数据库位置: user/prompt_bookmarks/prompt_bookmarks.db",
  ...
  "en-US": {
    ...
    importDbConfirm: "Restore SQLite database? Current database will be backed up as .db.bak.",
